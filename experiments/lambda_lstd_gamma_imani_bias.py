...
We measure the bias and variance LSTD\Gamma on the counterexample of Imani et al, 2018.

The output of this experiment will be found in `/plots/imani/lambda_lstd_gamma_bias/`
