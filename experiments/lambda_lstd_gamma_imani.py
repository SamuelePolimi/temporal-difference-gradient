...
ret_gamma = [np.array([train(alg)[0] for _ in range(10)]) for alg in lstd_gamma]

for ret, alg in zip(ret_gamma, lstd_gamma):
    np.save("../plots/imani/lambda_lstd_gamma/result_%.2f.npy" % alg._lambda, ret)
